          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-48 lg:px-8">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                You can see your teammates as avatars directly on your MacOS
                dock and start a voice call or screen-share with one click.
              </p>
              <div className="mt-5 sm:mt-8 sm:justify-center lg:justify-start md:w-auto lg:w-96 invisible md:visible">
                ...
                <div className="invisible md:visible text-gray-400 text-sm sm:mt-3 sm:flex sm:justify-center lg:justify-start">
                  * windows version coming soon
                </div>
                <div className="mt-10 text-xs text-gray-300">
                  Workdock | 2261 Market Street #4205, San Francisco, CA 94114
                </div>
              </div>
